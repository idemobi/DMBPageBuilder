# DMBPageBuilder Draw.io Diagram Rules
...
- Default area folder for this project: `PageBuilder`
...
```html
<img src="/drawio/PageBuilder/rendering-pipeline.drawio.svg" alt="PageBuilder rendering pipeline diagram" />
```
