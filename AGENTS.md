# AI Rules - DMBPageBuilder

## Scope

- Applies to `DMBPageBuilder` folder and descendants.
...
- Provide the foundational page rendering package for the PageBuilder ecosystem.
- Keep page metadata, HTML builders, Razor helpers, asset registration, and rendering behavior stable for consumers across the ecosystem.
