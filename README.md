...
- `New_PageInformation/`: page model, metadata definitions, script/style definitions, body rendering contracts, and page rendering entry points.
...
- `Models/`: shared enums and value objects used by rendering, icon, style, and action APIs.
