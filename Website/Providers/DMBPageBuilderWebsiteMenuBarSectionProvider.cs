...
internal sealed class DMBPageBuilderWebsiteMenuBarSectionProvider : IMenuBarSectionProvider
{
    ...
    public MenuBarModuleResult Build(TextWriter writer, IHtmlHelper html)
    {
        ...
        result.ActionList.Add(DMBPageBuilderLabsNavigationAgent.CreateMenuGroup());
